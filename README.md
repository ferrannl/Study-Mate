...
- **Language:** PHP (>= 7.2.5)  
- **Templating:** Blade  
- **Database:** Any Laravel-supported SQL database (MySQL/MariaDB, PostgreSQL, SQLite)  
- **Tooling:**
...
- `routes/` – Route definitions (`routes/web.php` for web routes)  
...
6. **Run migrations (and seeds if configured)**
   ```bash
   php artisan migrate
...
- Initial Laravel skeleton: [laravel/laravel](https://github.com/laravel/laravel)  
